...
enum : ImageIndex
{
    ...
    SPR_RIDE_DESIGN_PREVIEW_SPINNING_TRACK = SPR_G2_ALPINE_END,
    SPR_RIDE_DESIGN_PREVIEW_SPINNING_SUPPORTS = SPR_RIDE_DESIGN_PREVIEW_SPINNING_TRACK + 1,
    SPR_G2_SPINNING_BEGIN = SPR_RIDE_DESIGN_PREVIEW_SPINNING_TRACK + 2,
    SPR_G2_SPINNING_TRACK_FLAT = SPR_G2_SPINNING_BEGIN,
    SPR_G2_SPINNING_TRACK_BRAKE = SPR_G2_SPINNING_TRACK_FLAT + 2,

    SPR_G2_SPINNING_TRACK_DIAG_BRAKES = SPR_G2_SPINNING_TRACK_BRAKE + 2,
    SPR_G2_SPINNING_TRACK_DIAG_BLOCK_BRAKES = SPR_G2_SPINNING_TRACK_DIAG_BRAKES + 2,
    SPR_G2_SPINNING_TRACK_BLOCK_BRAKE_SW_NE_OPEN = SPR_G2_SPINNING_TRACK_DIAG_BLOCK_BRAKES + 4,
    SPR_G2_SPINNING_TRACK_BLOCK_BRAKE_SW_NE_CLOSED = SPR_G2_SPINNING_TRACK_BLOCK_BRAKE_SW_NE_OPEN + 1,
    SPR_G2_SPINNING_TRACK_BLOCK_BRAKE_NW_SE_OPEN = SPR_G2_SPINNING_TRACK_BLOCK_BRAKE_SW_NE_CLOSED + 1,
    SPR_G2_SPINNING_TRACK_BLOCK_BRAKE_NW_SE_CLOSED = SPR_G2_SPINNING_TRACK_BLOCK_BRAKE_NW_SE_OPEN + 1,

    SPR_G2_SPINNING_TRACK_BOOSTER = SPR_G2_SPINNING_TRACK_BLOCK_BRAKE_NW_SE_CLOSED + 1,
    SPR_G2_SPINNING_TRACK_POWERED_LIFT = SPR_G2_SPINNING_TRACK_BOOSTER + 2,
    SPR_G2_SPINNING_TRACK_GENTLE = SPR_G2_SPINNING_TRACK_POWERED_LIFT + 4,
    SPR_G2_SPINNING_TRACK_STEEP = SPR_G2_SPINNING_TRACK_GENTLE + 12,
    SPR_G2_SPINNING_TRACK_VERTICAL = SPR_G2_SPINNING_TRACK_STEEP + 16,

    SPR_G2_SPINNING_TRACK_CURVE_VERY_SMALL = SPR_G2_SPINNING_TRACK_VERTICAL + 12,
    SPR_G2_SPINNING_TRACK_SMALL_CURVE = SPR_G2_SPINNING_TRACK_CURVE_VERY_SMALL + 4,
    SPR_G2_SPINNING_TRACK_MEDIUM_CURVE = SPR_G2_SPINNING_TRACK_SMALL_CURVE + 12,
    SPR_G2_SPINNING_TRACK_LARGE_CURVE = SPR_G2_SPINNING_TRACK_MEDIUM_CURVE + 20,
    SPR_G2_SPINNING_TRACK_FLAT_DIAGONAL = SPR_G2_SPINNING_TRACK_LARGE_CURVE + 32,
    SPR_G2_SPINNING_TRACK_GENTLE_DIAGONAL = SPR_G2_SPINNING_TRACK_FLAT_DIAGONAL + 4,
    SPR_G2_SPINNING_TRACK_STEEP_DIAGONAL = SPR_G2_SPINNING_TRACK_GENTLE_DIAGONAL + 12,
    SPR_G2_SPINNING_TRACK_BANK_TRANSITION = SPR_G2_SPINNING_TRACK_STEEP_DIAGONAL + 12,
    SPR_G2_SPINNING_TRACK_BANK_TRANSITION_DIAGONAL = SPR_G2_SPINNING_TRACK_BANK_TRANSITION + 40,
    SPR_G2_SPINNING_TRACK_SMALL_CURVE_BANKED = SPR_G2_SPINNING_TRACK_BANK_TRANSITION_DIAGONAL + 34,
    SPR_G2_SPINNING_TRACK_MEDIUM_CURVE_BANKED = SPR_G2_SPINNING_TRACK_SMALL_CURVE_BANKED + 14,
    SPR_G2_SPINNING_TRACK_LARGE_CURVE_BANKED = SPR_G2_SPINNING_TRACK_MEDIUM_CURVE_BANKED + 22,
    SPR_G2_SPINNING_TRACK_GENTLE_SMALL_CURVE = SPR_G2_SPINNING_TRACK_LARGE_CURVE_BANKED + 32,
    SPR_G2_SPINNING_TRACK_GENTLE_MEDIUM_CURVE = SPR_G2_SPINNING_TRACK_GENTLE_SMALL_CURVE + 16,
    SPR_G2_SPINNING_TRACK_STEEP_SMALL_CURVE = SPR_G2_SPINNING_TRACK_GENTLE_MEDIUM_CURVE + 40,
    SPR_G2_SPINNING_TRACK_VERTICAL_TWIST = SPR_G2_SPINNING_TRACK_STEEP_SMALL_CURVE + 16,
    SPR_G2_SPINNING_TRACK_SLOPE_BANK_TRANSITION = SPR_G2_SPINNING_TRACK_VERTICAL_TWIST + 12,
    SPR_G2_SPINNING_TRACK_GENTLE_SMALL_CURVE_BANKED = SPR_G2_SPINNING_TRACK_SLOPE_BANK_TRANSITION + 64,
    SPR_G2_SPINNING_TRACK_GENTLE_MEDIUM_CURVE_BANKED = SPR_G2_SPINNING_TRACK_GENTLE_SMALL_CURVE_BANKED + 16,
    SPR_G2_SPINNING_TRACK_S_BEND = SPR_G2_SPINNING_TRACK_GENTLE_MEDIUM_CURVE_BANKED + 40,
    SPR_G2_SPINNING_TRACK_SMALL_HELIX = SPR_G2_SPINNING_TRACK_S_BEND + 16,
    SPR_G2_SPINNING_TRACK_LARGE_HELIX = SPR_G2_SPINNING_TRACK_SMALL_HELIX + 28,
    SPR_G2_SPINNING_TRACK_BARREL_ROLL = SPR_G2_SPINNING_TRACK_LARGE_HELIX + 44,
    SPR_G2_SPINNING_TRACK_INLINE_TWIST = SPR_G2_SPINNING_TRACK_BARREL_ROLL + 48,
    SPR_G2_SPINNING_TRACK_HALF_LOOP = SPR_G2_SPINNING_TRACK_INLINE_TWIST + 48,
    SPR_G2_SPINNING_TRACK_VERTICAL_LOOP = SPR_G2_SPINNING_TRACK_HALF_LOOP + 16,
    SPR_G2_SPINNING_TRACK_FLAT_TO_STEEP = SPR_G2_SPINNING_TRACK_VERTICAL_LOOP + 32,
    SPR_G2_SPINNING_TRACK_QUARTER_LOOP = SPR_G2_SPINNING_TRACK_FLAT_TO_STEEP + 32,
    SPR_G2_SPINNING_TRACK_CORKSCREW = SPR_G2_SPINNING_TRACK_QUARTER_LOOP + 12,
    SPR_G2_SPINNING_TRACK_LARGE_CORKSCREW = SPR_G2_SPINNING_TRACK_CORKSCREW + 24,
    SPR_G2_SPINNING_TRACK_TURN_BANK_TRANSITION = SPR_G2_SPINNING_TRACK_LARGE_CORKSCREW + 40,
    SPR_G2_SPINNING_TRACK_MEDIUM_HALF_LOOP = SPR_G2_SPINNING_TRACK_TURN_BANK_TRANSITION + 18,
    SPR_G2_SPINNING_TRACK_LARGE_HALF_LOOP = SPR_G2_SPINNING_TRACK_MEDIUM_HALF_LOOP + 40,
    SPR_G2_SPINNING_TRACK_ZERO_G_ROLL = SPR_G2_SPINNING_TRACK_LARGE_HALF_LOOP + 56,
    SPR_G2_SPINNING_TRACK_LARGE_ZERO_G_ROLL = SPR_G2_SPINNING_TRACK_ZERO_G_ROLL + 32,
    SPR_G2_SPINNING_TRACK_SMALL_FLAT_TO_STEEP = SPR_G2_SPINNING_TRACK_LARGE_ZERO_G_ROLL + 40,
    SPR_G2_SPINNING_TRACK_GENTLE_LARGE_CURVE = SPR_G2_SPINNING_TRACK_SMALL_FLAT_TO_STEEP + 20,
    SPR_G2_SPINNING_TRACK_GENTLE_LARGE_CURVE_BANKED = SPR_G2_SPINNING_TRACK_GENTLE_LARGE_CURVE + 64,

    SPR_G2_SPINNING_LIFT_BEGIN = SPR_G2_SPINNING_TRACK_GENTLE_LARGE_CURVE_BANKED + 128,
    SPR_G2_SPINNING_LIFT_TRACK_FLAT = SPR_G2_SPINNING_LIFT_BEGIN,
    SPR_G2_SPINNING_LIFT_TRACK_GENTLE = SPR_G2_SPINNING_LIFT_TRACK_FLAT + 4,
    SPR_G2_SPINNING_LIFT_TRACK_STEEP = SPR_G2_SPINNING_LIFT_TRACK_GENTLE + 12,
    SPR_G2_SPINNING_LIFT_TRACK_VERTICAL = SPR_G2_SPINNING_LIFT_TRACK_STEEP + 16,
    SPR_G2_SPINNING_LIFT_TRACK_FLAT_DIAGONAL = SPR_G2_SPINNING_LIFT_TRACK_VERTICAL + 12,
    SPR_G2_SPINNING_LIFT_TRACK_GENTLE_DIAGONAL = SPR_G2_SPINNING_LIFT_TRACK_FLAT_DIAGONAL + 4,
    SPR_G2_SPINNING_LIFT_TRACK_STEEP_DIAGONAL = SPR_G2_SPINNING_LIFT_TRACK_GENTLE_DIAGONAL + 12,
    SPR_G2_SPINNING_LIFT_TRACK_SMALL_FLAT_TO_STEEP = SPR_G2_SPINNING_LIFT_TRACK_STEEP_DIAGONAL + 12,
    SPR_G2_SPINNING_END = SPR_G2_SPINNING_LIFT_TRACK_SMALL_FLAT_TO_STEEP + 20,

    SPR_G2_ICON_MEDIUM_CURVE_LEFT = SPR_G2_SPINNING_END,
