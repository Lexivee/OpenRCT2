...
enum : ImageIndex
{
    ...
    SPR_G2_MINI_TRACK_DIAG_BLOCK_BRAKES = SPR_G2_MINI_TRACK_DIAG_BRAKES + 2,

    SPR_G2_MINI_TRACK_VERTICAL = SPR_G2_MINI_TRACK_DIAG_BLOCK_BRAKES + 4,
    SPR_G2_MINI_TRACK_VERTICAL_TWIST = SPR_G2_MINI_TRACK_VERTICAL + 12,
    SPR_G2_MINI_TRACK_BARREL_ROLL = SPR_G2_MINI_TRACK_VERTICAL_TWIST + 12,
    SPR_G2_MINI_TRACK_HALF_LOOP = SPR_G2_MINI_TRACK_BARREL_ROLL + 48,
    SPR_G2_MINI_TRACK_VERTICAL_LOOP = SPR_G2_MINI_TRACK_HALF_LOOP + 16,
    SPR_G2_MINI_TRACK_FLAT_TO_STEEP = SPR_G2_MINI_TRACK_VERTICAL_LOOP + 32,
    SPR_G2_MINI_TRACK_QUARTER_LOOP = SPR_G2_MINI_TRACK_FLAT_TO_STEEP + 32,
    SPR_G2_MINI_TRACK_CORKSCREW = SPR_G2_MINI_TRACK_QUARTER_LOOP + 12,
    SPR_G2_MINI_TRACK_LARGE_CORKSCREW = SPR_G2_MINI_TRACK_CORKSCREW + 24,
    SPR_G2_MINI_TRACK_TURN_BANK_TRANSITION = SPR_G2_MINI_TRACK_LARGE_CORKSCREW + 40,
    SPR_G2_MINI_TRACK_MEDIUM_HALF_LOOP = SPR_G2_MINI_TRACK_TURN_BANK_TRANSITION + 18,
    SPR_G2_MINI_TRACK_LARGE_HALF_LOOP = SPR_G2_MINI_TRACK_MEDIUM_HALF_LOOP + 40,
    SPR_G2_MINI_TRACK_ZERO_G_ROLL = SPR_G2_MINI_TRACK_LARGE_HALF_LOOP + 56,
    SPR_G2_MINI_TRACK_LARGE_ZERO_G_ROLL = SPR_G2_MINI_TRACK_ZERO_G_ROLL + 32,
    SPR_G2_MINI_TRACK_SMALL_FLAT_TO_STEEP = SPR_G2_MINI_TRACK_LARGE_ZERO_G_ROLL + 40,
    SPR_G2_MINI_TRACK_GENTLE_LARGE_CURVE = SPR_G2_MINI_TRACK_SMALL_FLAT_TO_STEEP + 20,
    SPR_G2_MINI_TRACK_GENTLE_LARGE_CURVE_BANKED = SPR_G2_MINI_TRACK_GENTLE_LARGE_CURVE + 64,
    SPR_G2_MINI_TRACK_INLINE_TWIST = SPR_G2_MINI_TRACK_GENTLE_LARGE_CURVE_BANKED + 128,
    SPR_G2_MINI_RC_END = SPR_G2_MINI_TRACK_INLINE_TWIST + 48,
